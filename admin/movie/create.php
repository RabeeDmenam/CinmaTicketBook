...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (count($errors) > 0) {
        ...
        if (move_uploaded_file($tmpPath, $desPath)) {
            ...
            $sql_insert_movie = "insert into movie (movie_name, movie_type, movie_description, movie_ticket_price, moive_offer_proce, movie_created_date, movie_start_date, movie_end_date, start_show_date, image) values ('$movie_name', '$movie_type','$movie_description', '$movie_ticket_price', '$moive_offer_proce','$movie_created_date','$movie_start_date', '$movie_end_date', '$start_show_date', '$FinalName')";
            $op_moive  = mysqli_query($con,$sql_insert_movie);
    ...
    <main>
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">Dashboard/Add movie</li>
                ...
                <div class="container">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputName" name="movie_name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="exampleInputPassword1" name="movie_ticket_price"
                                   placeholder="movie ticket price">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword">movie offer price </label>
                            <input type="number" class="form-control"  name="moive_offer_proce"
                                   placeholder="movie offer price">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword">movie start date</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="movie_start_date"
                                   placeholder="movie start date">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword"> movie end date</label>
                            <input type="date" class="form-control" id="exampleInputPassword1" name="movie_end_date"
                                placeholder="movie end date">
                        </div>
                            <div class="form-group">
                                    <label for="exampleInputPassword"> start show date</label>
                                    <input type="date" class="form-control" id="exampleInputPassword1" name="start_show_date"
                                        placeholder="start show date">
                                </div>
                                        <div class="form-group">
                                    <label for="exampleInputPassword"> movie created date</label>
                                    <input type="date" class="form-control" id="exampleInputPassword1" name="movie_created_date"
